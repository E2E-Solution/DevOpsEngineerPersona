/**
 * Generate an ICS calendar file for the Zava Gift Exchange event
 */
export function generateICS(event: {
  ...
  const randomHex = Array.from(randomBytes)
    ...
    .join('')
  const uid = `ZavaGiftExchange-${dateParts}-${randomHex}@ZavaGiftExchange`
