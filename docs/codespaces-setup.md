...
- **Azure Functions Core Tools v4** - Run the API locally
...
3. Installs Playwright browsers for E2E testing
4. Starts Docker containers (Cosmos DB + Azurite emulators) on every container start
