...
- **COSMOS_DATABASE_NAME**: `ZavaGiftExchange`
...
curl -X GET "https://localhost:8081/dbs/ZavaGiftExchange/colls/games/docs" \
...
- **Issue?** Check [GitHub Issues](https://github.com/Azure-Samples/DevOpsEngineerPersona/issues)
- **Question?** Create a [Discussion](https://github.com/Azure-Samples/DevOpsEngineerPersona/discussions)
